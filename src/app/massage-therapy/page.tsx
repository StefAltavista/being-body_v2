      ...
      <div ref={container} className="w-full">
        ...
        <div className="w-full relative">
          ...
          <div className="mb-6">
            <p className="reveal-p !text-[26px] !mt-8 !text-left">
              ...
              restore balance to body and mind. <br></br>Working with attention
              and love to discover roots of pain and dissolve them.
            </p>
          </div>
          <BookButton />

          <div className="w-full flex flex-col items-center mb-8">
            <div className="massage-hero-wrapper relative sm:w-full md:w-[80%] lg:w-[50%] h-[100vh] my-8 flex items-center overflow-hidden rounded-full">
              <Image
              ...
              <div className="px-15 flex flex-col items-center">
                <h3 className="reveal-p !text-white mb-16">
                  Presence in touch
                </h3>

                <p className="reveal-p handWrite2 !text-white">
                  I use a mix of techniques, guided by what the body tells me.{" "}
                  <br />
                  My intention is to create a space to listen; bring people into
                  a place where they can hear themselves, connect with
                  themselves. <br />
                  <br />
                  ...
                  to be a dance between giver and receiver. <br />
                  <br />
          ...
          <p className="reveal-p !text-[26px] !text-center">
            Restore balance, connection and well-being
            <br />
            <br />
        ...
        <div className=" w-full flex flex-col justify-center items-center !mt-26">
          <div className="w-full flex flex-col items-center lg:grid lg:grid-cols-2 lg:gap-x-16 lg:gap-y-20 lg:items-start">
            ...
            <div className="flex flex-col items-center xl:px-16 ">
              <Bubble text={"Energy Lines"} className="mt-6" delay={0 + "s"} />
              <p className="reveal-p !my-16 lg:!my-8 handWrite2">
            ...
            <div className="flex flex-col items-center xl:px-16 ">
              <Bubble text={"Circulatory"} className="mt-6" delay={1 + "s"} />
              <p className="reveal-p !my-16 lg:!my-8 handWrite2">
